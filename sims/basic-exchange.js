...
const depositEth = (ethInputAmount) => {
  ...
  console.log(`deposited ${ethInputAmount} ETH in exchange for ${tokenOutputAmount} IFY`)
...
const depositToken = (tokenInputAmount) => {
  ...
  console.log(`deposited ${tokenInputAmount} IFY in exchange for ${ethOutputAmount} ETH`)
  console.log('  slippage', slippage, '%')
